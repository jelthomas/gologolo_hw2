...
class App extends Component {
   ...
   */
  buildChangeLogoTransaction = (oldLogo, logoKey, newText, newTextColor, newFontSize, newTextBackgroundColor, newBorderColor, newBorderRadius, newBorderWidth, newPadding) => {
